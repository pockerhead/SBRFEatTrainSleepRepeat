...
- (UIView *)tableView:(UITableView *)tableView viewForHeaderInSection:(NSInteger)section
{
    if (section < self.dataSource.count) {
        ...
        MealTableViewHeader *view = [self.tableView dequeueReusableHeaderFooterViewWithIdentifier:NSStringFromClass([MealTableViewHeader class])];
        __weak typeof(self) weakSelf = self;
        viewModel.tapAction = ^{
            [weakSelf.presenter didSelectMealHeaderWithIndex:section];
        };
...
- (UIView *)tableView:(UITableView *)tableView viewForFooterInSection:(NSInteger)section
{
    if (section < self.dataSource.count) {
        ...
        MealTableFooter *view = [self.tableView dequeueReusableHeaderFooterViewWithIdentifier:NSStringFromClass([MealTableFooter class])];
        __weak typeof(self) weakSelf = self;
        viewModel.tapAction = ^{
            [weakSelf.presenter didSelectMealFooterWithIndex:section];
        };
        [view configureWithViewModel:viewModel];
        return view;
    }
